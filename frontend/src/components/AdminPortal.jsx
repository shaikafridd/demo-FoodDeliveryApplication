        ...
        <div className="modal-backdrop">
          <div className="modal-card">
            ...
            <form onSubmit={handleCreateOrderSubmit} className="modal-form">
              ...
              <div className="form-group">
                <label>Ordered Items (Comma Separated)</label>
                <input 
                  type="text" 
                  placeholder="e.g. 1x Chicken Biryani, 2x Butter Naan" 
          ...
          <div className="modal-card invoice-modal">
            ...
            <div className="invoice-print-body">
              <div className="invoice-brand-row">
                <span className="brand-title">Spice House Restaurant</span>
                <span className="pay-badge pay-paid">PAID VIA UPI</span>
              </div>
              <div className="invoice-details-grid">
                <div>
                  <strong>Order #: {invoiceOrder.orderNumber}</strong><br />
                  <span>Customer: {invoiceOrder.customerName}</span><br />
                  <span>Phone: {invoiceOrder.customerPhone}</span>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <span>Status: {invoiceOrder.orderStatus}</span><br />
              ...
              <ul className="invoice-items-list">
                {invoiceOrder.items.map((item, idx) => (
                  <li key={idx}>• {typeof item === 'string' ? item : `${item.quantity || 1}x ${item.name}`}</li>
                ))}
              </ul>
              <hr className="divider-line" />
              ...
              <div className="commission-saved-note">
                ⚡ 100% Direct Payout — ₹0 Aggregator Commission Deducted
              </div>
            </div>
            <div className="modal-footer">
